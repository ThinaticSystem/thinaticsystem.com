...
test('v2 retains parent and precisely two additional measured nodes',()=>{
...
test('runtime requires actual Node22, exact executable, Corepack, pnpm and lock',()=>{
...
test('measurement rejects missing/wrong browser, axe, driver and Playwright',()=>{
...
test('source identity covers tracked/untracked bytes, modes, additions/deletions; excludes generated',()=>{
...
test('build identity detects output bytes and missing index',()=>{
...
test('parent and substrate bytes cannot be silently changed',()=>{
...
test('CI selects baseline before candidate, runs required local gates, and never ignores failure',()=>{
