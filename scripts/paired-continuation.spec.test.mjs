...
test('When the recorded scenario is exercised Then the contract demonstrates that v2 retains parent and precisely two additional measured nodes',()=>{
...
test('When the recorded scenario is exercised Then the contract demonstrates that runtime requires actual Node22, exact executable, Corepack, pnpm and lock',()=>{
...
test('When the recorded scenario is exercised Then the contract demonstrates that measurement rejects missing/wrong browser, axe, driver and Playwright',()=>{
...
test('When the recorded scenario is exercised Then the contract demonstrates that source identity covers tracked/untracked bytes, modes, additions/deletions; excludes generated',()=>{
...
test('When the recorded scenario is exercised Then the contract demonstrates that build identity detects output bytes and missing index',()=>{
...
}))test('content-addressed v2 rejects mutated '+name,()=>{
...
test('When the recorded scenario is exercised Then the contract demonstrates that parent and substrate bytes cannot be silently changed',()=>{
...
test('When the recorded scenario is exercised Then the contract demonstrates that CI selects baseline before candidate, runs required local gates, and never ignores failure',()=>{
