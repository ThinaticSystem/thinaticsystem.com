...
test('asset extraction accepts either HTML attribute order and excludes external assets', () => {
...
test('asset extraction requires the relevant module and stylesheet markers', () => {
