...
const selected = selectPreviewDeployment(parseDeploymentsResponse(await response.text()), {commitSha, branch: 'chore-modernization-renovate', environment: 'preview', actionUrl});
