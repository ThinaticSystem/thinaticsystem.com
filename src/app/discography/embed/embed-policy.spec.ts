...
describe('Media embed policy', () => {
  ...
  it('admits the observed complete corpus without inventing a player for null', () => {
  ...
  it('retains safe SoundCloud appearance but fixes autoplay off', () => {
  ...
  it('preserves nocookie choice and removes Spotify tracking parameters', () => {
  ...
  it('does not forward CMS attributes or styles in the admitted model', () => {
