...
describe('Given the sanitizer receives HTML from content input', () => {
  beforeEach(() => {
  ...
  it('When cannot bypass the dedicated player allowlist through generic HTML', () => {
